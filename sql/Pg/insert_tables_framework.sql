INSERT INTO fw_database (dbname, dbtype, dbusername, dbpassword, dbhost, dbschema) VALUES ('test', 'Pg', '', '', 'localhost', 'freemoney');
INSERT INTO fw_database (dbname, dbtype, dbusername, dbpassword, dbhost, dbschema) VALUES ('freemoney', 'Pg', '', '', 'localhost', 'freemoney');

INSERT INTO fw_user (name, "password") VALUES ('Freemoney', 'test');
INSERT INTO fw_user (name, "password") VALUES ('test', 'test');

INSERT INTO fw_usergroup (name, db_id, domainname) VALUES ('Testers', 1, 'freemoney');
INSERT INTO fw_usergroup (name, db_id, domainname) VALUES ('Freemoney', 2, 'freemoney');
